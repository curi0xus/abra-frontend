...
import type { BentoAbi, BentoAbiInterface } from "../BentoAbi";
...
export class BentoAbi__factory {
  static readonly abi = _abi;
  static createInterface(): BentoAbiInterface {
    return new utils.Interface(_abi) as BentoAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BentoAbi {
    return new Contract(address, _abi, signerOrProvider) as BentoAbi;
  }
}
