...
import type { CauldronAbi, CauldronAbiInterface } from "../CauldronAbi";
...
export class CauldronAbi__factory {
  static readonly abi = _abi;
  static createInterface(): CauldronAbiInterface {
    return new utils.Interface(_abi) as CauldronAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CauldronAbi {
    return new Contract(address, _abi, signerOrProvider) as CauldronAbi;
  }
}
